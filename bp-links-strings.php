<?php
/*
 * These are strings for the pro version.
 * If you translate them, you are awesome!
 */

__( 'A Group', 'buddypress-links' );
__( 'All Group Links', 'buddypress-links' );
__( 'Cancel', 'buddypress-links' );
...
__( 'Sharing a link with yourself is not allowed.', 'buddypress-links' );
__( 'Sharing this link has failed.', 'buddypress-links' );
__( 'Sharing this link in your profile has failed.', 'buddypress-links' );
...
__( 'This link has been removed from this group.', 'buddypress-links' );
__( 'This link has been removed from your profile.', 'buddypress-links' );
__( 'This link has been shared with the %s group.', 'buddypress-links' );
__( 'This link was previously removed from the %s group by an admin or moderator.', 'buddypress-links' );
